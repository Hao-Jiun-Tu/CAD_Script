...
set_operating_conditions -library $LIBRARY_NAME $LIBRARY_CONDITION
...
# set_dont_use [format "%s%s" $LIBRARY_FILENAME {/AOI*}]
# set_dont_use [format "%s%s" $LIBRARY_FILENAME {/OA*}]