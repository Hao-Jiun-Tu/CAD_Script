...
report_area -designware > ./report/report_area_dw_${TOPLEVEL}.out

# ===== Power report =====
report_power -hier > ./report/report_power_${TOPLEVEL}.out

# ===== resources =====
report_resources -hier > ./report/report_resources_${TOPLEVEL}.out

# ===== violations =====
report_constraint -all_violators > ./report/report_violation_${TOPLEVEL}.out

# ===== others =====
report_reference > ./$RPT_DIR/report_reference_${TOPLEVEL}.out
report_cell [all_registers] > ./$RPT_DIR/report_cell_all_registers_${TOPLEVEL}.out
report_qor > ./$RPT_DIR/report_qor_${TOPLEVEL}.out
